...
class CustomOrderSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        if (!$obj) {
            ...
            $obj->order_date = "2022-10-20";
            $obj->finish_date = "2022-11-01";
        ...
        if (!$obj) {
            ...
            $obj->order_date = "2022-10-29";
            $obj->finish_date = "2022-11-10";
        ...
        if (!$obj) {
            ...
            $obj->order_date = "2022-10-23";
            $obj->finish_date = "2022-11-04";
        ...
        if (!$obj) {
            ...
            $obj->order_date = "2022-10-22";
            $obj->finish_date = "2022-11-11";
            $obj->deposit_payment_method = "transfer";
            $obj->deposit_slip_image = "photo";
        ...
        if (!$obj) {
            ...
            $obj->order_date = "2022-10-28";
            $obj->finish_date = "2022-11-08";
            $obj->deposit_payment_method = "transfer";
            $obj->deposit_slip_image = "photo";
        ...
        if (!$obj) {
            ...
            $obj->order_date = "2022-10-15";
            $obj->finish_date = "2022-11-02";
            $obj->deposit_payment_method = "cash";
            $obj->deposit_paid_amount = 9500;
            $obj->deposit_change_amount = 57;
            $obj->custom_order_status = "เสร็จสิ้น";
            $obj->delivery_date = "2022-11-04";
